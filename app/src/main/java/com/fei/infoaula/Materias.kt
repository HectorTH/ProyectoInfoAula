...
// Modelo de datos para mapear la estructura por turnos de oferta_clases
...
class Materias : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // SOLUCIÓN AL INSETS: Se aplica el padding al contenedor general de la ventana de forma segura
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(android.R.id.content)) { _, insets ->
            val systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars())

            // Le damos su margen superior al Toolbar para que libre la hora y batería del cel
            toolbar?.let {
        ...
        // Validación del rol del usuario mediante el correo institucional
        ...
        dbRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (materiaSnapshot in snapshot.children) {
                    // Tomamos directamente la llave ("Networking") como el nombre
                ...
                // Si todo corrió bien, refrescamos el adaptador con la lista cargada
    ...
    class AdaptadorMaterias(
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            // ADAPTACIÓN DE COLORES PARA TUS TEXTOS REALES
