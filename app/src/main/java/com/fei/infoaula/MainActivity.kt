...
class MainActivity : AppCompatActivity() {
    ...
    // CRÍTICO: Cambiar a false para producción o el examen presencial
    ...
    // Modificamos la función para recibir y transportar el UID único
    private fun evaluarRolYEntrar(usuario: String, uid: String) {
        val usuarioMinuscula = usuario.lowercase()
        val intent = Intent(this, Inicio::class.java)

        // EMPACAMOS EL UID PARA LA PANTALLA DE INICIO
