...
class Buscar : AppCompatActivity() {
    ...
    // Cambiamos a una lista de objetos de un modelo interno para separar los campos de texto
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Inicializar nuestro adaptador mejorado
                            ...
                            if (nombre != null) {
                                listaCompletaUniverso.add(
                                    ElementoBusqueda(
                                        ...
                                        linea3 = "✉️ Correo: $correo  |  ID: $numPersonal"
                                    )
                                )
                            }
                        }
    ...
    private fun filtrarBusqueda(texto: String) {
        ...
        if (query.isEmpty()) {
            ...
            for (item in listaCompletaUniverso) {
                // Evalúa de forma cruzada cualquiera de los campos guardados
    ...
    // CLASE DE MODELO PARA PASAR DATOS LIMPIOS AL ADAPTADOR
    ...
    // ADAPTADOR PERSONALIZADO PARA INFLAR CARDS EN EL LISTVIEW
    class AdaptadorBusqueda(private val context: Context, private val items: List<ElementoBusqueda>) : BaseAdapter() {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            // Cambiar dinámicamente el color del tag según el rol
